...
| [Z90](single_qubit/sq_Z90.md)                             | Z90         | $Z^{1/2}$                                          | **`Z90 q[0]`**               |
| [minus-Z90](single_qubit/sq_mZ90.md)                      | mZ90        | $Z^{-1/2}$                                         | **`mZ90 q[0]`**              |
...
| [U](single_qubit/sq_U.md)                                 | U           | $U(\theta, \phi, \lambda)$                         | **`U(pi/2,0,pi) q[0]`**      |
...
| [Magic](multi_qubit/mq_M.md)                              | M           | $M$                                                | **`M q[0], q[1]`**           |
| [Mølmer-Sørensen](multi_qubit/mq_MS.md)                   | MS          | $MS$                                               | **`MS q[0], q[1]`**          |
| [Square-root-iSWAP](multi_qubit/mq_SqrtISWAP.md)          | SqrtISWAP   | $\sqrt{iSWAP}$                                     | **`SqrtISWAP q[0], q[1]`**   |
| [Square-root-SWAP](multi_qubit/mq_InvSqrtSWAP.md)         | SqrtSWAP    | $\sqrt{SWAP}$                                      | **`SqrtSWAP q[0], q[1]`**    |
