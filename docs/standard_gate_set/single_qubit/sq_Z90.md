...
The Z90 gate or Phase gate is an anti-clockwise rotation of $\pi / 2$ [rad] about the $\hat{\mathbf{z}}$-axis and
a global phase of $\pi / 4$ [rad].

It is equal to the [S gate](sq_S.md): $S = Z^{1/2}$.

### Aliases

Also known as the _S_ gate.
...
In the [Hadamard](sq_H.md) basis $\{|+\rangle, |-\rangle\}$, the Z90 gate $Z^{1/2}_H$ is given by:

$$Z^{1/2}_H = HZ^{1/2}H = \frac{1}{2}\left(\begin{matrix}
1 + i & 1 - i \\ 
1 - i & 1 + i 
